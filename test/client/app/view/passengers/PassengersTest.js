describe("The passengers page", function () {
    ...
    describe("has a form submission", function () {
        ...
        describe("each passenger has a first name", function () {
            ...
            it("does not submit when any first name is empty", function () {
                expect(view.isValid()).toBe(false);
            });

            it("does not submit when a first name is more than 30 characters", function () {
                setFirstName(view, ['abcdefghijklmnopqrstuvwxyz12345', 'John', 'Allana']);
                expect(view.isValid()).toBe(false);
            });

            it("does submit when a first name is 30 characters", function () {
                setFirstName(view, ['abcdefghijklmnopqrstuvwxyz1234', 'John', 'Allana']);
                expect(view.isValid()).toBe(true);
            });

            it("does submit when a first name is one character", function () {
                setFirstName(view, ['a', 'John', 'Allana']);
                expect(view.isValid()).toBe(true);
            });

            it("does submit when a first name is less than 30 characters", function () {
        ...
        describe("each passenger has a last name", function () {
            ...
            it("does not submit when any last name is empty", function () {
                expect(view.isValid()).toBe(false);
            });

            it("does not submit when a last name is more than 30 characters", function () {
            ...
            it("does submit when a last name is one character", function () {
                setLastName(view, ['a', 'Smith', 'Smith']);
                expect(view.isValid()).toBe(true);
            });

            it("does submit when a last name is less than 30 characters", function () {
        ...
        describe("each passenger has a ticket type", function () {
            ...
            it("does not submit when any ticket type is empty", function () {
                setTicketType(view, ['', '', '', '']);
                expect(view.isValid()).toBe(false);
            });
        ...
        describe("each passenger has a luggage type", function () {
            ...
            it("does submit when all luggage types are only carry-on", function () {
                setLuggageType(view, ['Only Carry-On Luggage', 'Only Carry-On Luggage']);
                expect(view.isValid()).toBe(true);
            });

            it("does submit when all luggage types are carry-on with checked baggage", function () {
                setLuggageType(view, ['Carry-On Plus Checked Baggage', 'Carry-On Plus Checked Baggage']);
                expect(view.isValid()).toBe(true);
            });

            it("does submit when all luggage types are different", function () {
